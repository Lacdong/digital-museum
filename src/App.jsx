...
export default function App() {
  // Quản lý tab hiện tại, mặc định ban đầu là 'home' (Trang chủ)
  const [activeTab, setActiveTab] = useState("home");

  return (
    <div className="bg-[#0B0F17] text-white min-h-screen">
      {/* Gọi Header duy nhất 1 lần tại đây và truyền trạng thái tab vào */}
      ...
      {/* Hiện thông báo tạm thời cho các tab chưa code nội dung */}
      {activeTab !== "home" && activeTab !== "member" && (
